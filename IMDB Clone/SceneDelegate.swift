...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let localDataHelper = LocalDataHelperImp()
        let dataRepository = DataRepositoryImpl(localDataHelper: localDataHelper)
        let movieListViewModel = MovieListViewModel(dataRepository: dataRepository)
